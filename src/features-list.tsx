  ...
  return (
    <div className="bg-white text-black">
      ...
      <header className="text-center py-16">
        ...
        <div className="p-4 bg-white rounded-lg shadow-md w-64 text-center flex flex-col items-center">
          <Image src="/image-upload.svg" alt="Feature 1" width={25} height={25} className="mb-2" />
          ...
          <div className="p-4 bg-white-100 rounded-lg shadow-md w-64 text-center  flex flex-col items-center">
