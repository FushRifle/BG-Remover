...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[30rem] bg-gradient-to-r from-blue-500 via-pink-500 to-orange-500 text-white flex flex-col justify-between">
      {/* Breadcrumbs */}
      <div className="container mx-auto px-4 py-4 text-sm text-gray-200">
      ...
      <div className="absolute bottom-0 w-full">
        <Image src="/divider.svg" alt="Divider" width={1440} height={100} className="w-full" />
      </div>
    </div>
  );
}
