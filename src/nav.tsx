...
export const Navbar = () => {
  ...
  return (
    <nav className="px-6 py-2 border-b border-gray-200">
      {/* Top Section: Logo, Search Bar, My Projects, Create a Design */}
      <div className="flex items-center justify-between pb-2">
        {/* Left Section - Logo */}
        <div className="flex items-center space-x-1">
          <span className="text-2xl font-bold text-purple-600">BG Remover</span>
        ...
        <div className="flex-1 max-w-5xl mx-auto relative">
          ...
          <input
            ...
            className="w-full px-10 py-2 border border-gray-300 rounded-lg focus:outline-none placeholder-gray-400"
          />
        </div>
...
<div className="flex justify-between items-center w-full">
  ...
  <div className="flex space-x-6">
    <span className="text-gray-700 cursor-pointer">Templates</span>
    ...
    >
      <span className="flex items-center gap-1 text-gray-700 cursor-pointer">
        Features <FiChevronDown className="text-gray-500" />
      </span>
      {isDropdownOpen && (
  ...
  <a href="#" className="text-purple-600 text-sm font-semibold font-medium">
    Browse assets →
  </a>
</div>
</nav>
