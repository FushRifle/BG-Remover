...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-gray-700 py-10 px-8">
      <div className="container mx-auto grid grid-cols-5 md:grid-cols-5 gap-8 mt-9">
        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <Link href="#" className="flex items-center mt-2 text-sm text-gray-700 hover:underline">
              Careers
              <span className="ml-2 bg-purple-100 text-purple-600 text-xs font-semibold px-2 py-1 rounded-full">
                Hiring
              </span>
            </Link>
            <Link href="#" className="block mt-2 text-sm text-gray-700 hover:underline">
              Blog - The Artistry
            </Link>
          </div>
        </div>
        ...
        {/* Learn Section */}
        <div>
          <h4 className="text-gray-900 font-semibold">Learn</h4>
        ...
        {/* Links Section */}
        <div>
          <h4 className="text-gray-900 font-semibold">Links</h4>
          <ul className="mt-2 space-y-1 text-sm">
            {[
              "Help Center",
              "Print on Demand (POD)",
        ...
        {/* Tools Section */}
        <div>
          <h4 className="text-gray-900 font-semibold">Tools</h4>
          <ul className="mt-2 space-y-1 text-sm">
            {[
              "Features",
              "Background remover",
        ...
        <div>
          <h4 className="text-gray-900 font-semibold">Contact</h4>
          <p className="text-sm text-purple-600 hover:underline cursor-pointer">hi@creativefabrica.com</p>
          ...
          <h4 className="mt-6 text-gray-900 font-semibold">Secure Checkout</h4>
      ...
      {/* Footer Bottom */}
      <div className="mt-10 border-t pt-6 flex items-center justify-between text-sm text-gray-500">
